...
<div width="5%" style=" padding-left: 10px;font-weight: 700;line-height: 25px">
        ...
        <div class="relative" width="5%"><a href="../zcgl.do" target="main">资产管理</a>
            <div class="absolute"></div>
        </div>
        <div class="relative" width="5%"><a href="../zc_check/checkzc.jsp" target="main">资产查询</a>
            <div class="absolute"></div>
        </div>

        <div class="relative" width="5%"><a href="../lendInfos.do" target="main" target="main">借还管理 </a>
            <div class="absolute"></div>
        </div>
        <div class="relative" width="5%"><a href="../zc_inout/zcInOutCheck.jsp" target="main">借还查询 </a>
            <div class="absolute"></div>
        </div>
        <div class="relative" width="5%"><a href="../assetPerAction.do" target="main">维修管理 </a>
            <div class="absolute"></div>
        </div>

        <div class="relative" width="5%"><a href="../zc_wx/checkZcwxInfo.jsp" target="main">维修查询 </a>
            <div class="absolute"></div>
        </div>

        <div class="relative" width="5%"><a href="../employeeAction.do" target="main">员工管理 </a>
            <div class="absolute"></div>
        </div>

        <div class="relative" width="5%"><a href="../printStoreIn.do" target="main">打印报表 </a>
            <div class="absolute"></div>
        </div>
        ...
        <div class="relative" width="5%"><a href="../user_info/updatepwd.jsp" target="main">修改密码 </a>
            <div class="absolute"></div>
